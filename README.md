...
```bash
python abs_da.py --init_parm=<α> --init_trace=<No. traces>  
```
...
```bash
python abs_z3.py --init_parm=<α> --init_trace=<No. traces>  
```
...
```bash
python da.py --init_trace=<No. traces>  
python z3.py --init_trace=<No. traces>  
```
