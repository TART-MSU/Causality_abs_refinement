...
def main():
    ...
    passed, times, states, modes, ps_list, Nz_list, u_list = RunF16Sim(initialState, tMax, der_func, f16_plant, ap, llc, pass_fail, sim_step=0.01)
    ...
    plot2d(filename, times, [
        (states, [(0, 'Vt'), (11, 'Altitude')]), (u_list, [(0, 'Throttle'), (1, 'elevator')]), (Nz_list, [(0, 'Nz')]) ])
